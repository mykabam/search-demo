...
var multiSearch = function(q, searchBy, callback) {
  ...
  var searchByAction = {
    courses: function(r) { return r._source.title },
    documents: function(r) { return r._source.title },
    schools: function(r) { return r._source.name },
    students: function(r) { return r._source.name }
  };
